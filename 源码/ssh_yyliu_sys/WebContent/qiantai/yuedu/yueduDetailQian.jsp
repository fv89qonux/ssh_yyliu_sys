		   ...
		   <div class="main_index">
		        <div class="content dz" style="margin-top: 10px;width: 70%;height: 100%;margin-left: 210px;" >
				   <table width="100%" border="0">
					    <tr>
					       <td align="center">信息标题：${requestScope.yuedu.biaoti }<hr/></td>
					    </tr>
					    <tr>
					       <td align="center" style="word-break:break-all;">信息内容：<c:out value="${requestScope.yuedu.neirong }" escapeXml="false"></c:out><hr/></td>
					    </tr>
					    <tr>
					       <td align="center">发布时间:${requestScope.yuedu.shijian }<hr/></td>
					    </tr>
					</table>
	            </div>
				<center>
