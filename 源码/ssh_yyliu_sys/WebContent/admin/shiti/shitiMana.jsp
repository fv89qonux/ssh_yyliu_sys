	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						<s:if test='#shiti.leixing=="jingjiang"'>试题精讲</s:if>
						<s:if test='#shiti.leixing=="zhuangxiang"'>专项练习</s:if>
					</td>
					<td bgcolor="#FFFFFF" align="center">
					...
					<td bgcolor="#FFFFFF" align="center">
						...
						&nbsp;&nbsp;&nbsp;
						<a href="#" onclick="down1('<s:property value="#shiti.fujian"/>','<s:property value="#shiti.fujianYuanshiming"/>')" style="font-size: 10px;color: red">down</a>
					</td>
					<td bgcolor="#FFFFFF" align="center">
			...
			<table width='98%'  border='0'style="margin-top:8px;margin-left: 8px;">
			  <tr>
			    <td>
			      <input type="button" value="添加试题" style="width: 120px;" onclick="shitiAdd()" />
			    </td>
			  </tr>
		    </table>
	</body>
